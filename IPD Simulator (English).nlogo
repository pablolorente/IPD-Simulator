...
to accion-propia
  ...
  if set-my-strategy-for-all-rounds [
    ...
    if my-strategy-for-all-rounds = "Random" [ifelse (random-float 1.0 < 0.5) [set delatar-ahora? false] [set delatar-ahora? true]]
  ]
end
...
my-strategy-for-all-rounds
"Always cooperate" "Always defect" "Friedman" "Tit for tat" "Pavlov" "Random"
2
