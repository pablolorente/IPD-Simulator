...
to accion-propia
  ...
  if fijar-estrategia-para-las-n-rondas [
    ...
    if mi-estrategia-para-las-n-rondas = "Aleatorio" [ifelse (random-float 1.0 < 0.5) [set delatar-ahora? false] [set delatar-ahora? true]]
  ]
end
...
mi-estrategia-para-las-n-rondas
"Siempre cooperar" "Siempre delatar" "Friedman" "Tit for tat" "Pavlov" "Aleatorio"
5
